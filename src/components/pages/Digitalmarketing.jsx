  ...
  export default function DigitalMarketing() {
    ...
    return (
      <>
        <Helmet>
        <meta name="keywords" content="Digital marketing agency Dubai, Digital marketing service in Dubai, Digital marketing service in UAE, Digital marketing company Dubai, Digital marketing company UAE, Digital marketing companies in Dubai" />
          <link rel="canonical" href="https://www.maxleadadvertising.com/digital-marketing-agency/" /></Helmet>
        <Whatsapp />
        <ScrollToTop />
        <Navigation />
